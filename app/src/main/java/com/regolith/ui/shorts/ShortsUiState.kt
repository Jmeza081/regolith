 ...
 * "there are no vertical clips on this share", while a [measuringLine] is
 * "we have not finished looking". Showing the same words for both is how an
 * empty feed comes to look broken.
 */
